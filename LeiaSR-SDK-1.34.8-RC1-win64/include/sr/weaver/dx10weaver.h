...
{
    /*!
     * \brief class to be used for weaving in DirectX 10 applications
     *
     * \ingroup API
     */
    class IDX10Weaver1 : public virtual IDestroyable, public virtual IQueryInterface, public virtual IWeaverBase1
    {
    public:
         ...
         */
        virtual void setInputViewTexture(ID3D10ShaderResourceView* texture, int width, int height, DXGI_FORMAT format) = 0;

    protected:
        IDX10Weaver1() = default;
        virtual ~IDX10Weaver1() = 0;

        IDX10Weaver1(const IDX10Weaver1&) = delete;
        IDX10Weaver1& operator=(const IDX10Weaver1&) = delete;
        IDX10Weaver1(IDX10Weaver1&&) = delete;
        IDX10Weaver1& operator=(IDX10Weaver1&&) = delete;
    };

    /*!
     * \brief Creates a new DirectX 10 weaver.
     *
     * \param Context to connect to
     * \param d3d10Device Pointer to D3D10 device
     ...
     * \ingroup API
     */
    DIMENCOSR_API WeaverErrorCode CreateDX10Weaver(SRContext* context, ID3D10Device* d3d10Device, HWND window, IDX10Weaver1** weaver);
...
#pragma warning(suppress: 4251)
    ...
    class [[deprecated("This class is deprecated, please use IDX10Weaver instead.")]] DIMENCOSR_API DX10Weaver : public DX10WeaverBase {
    public:
        /*!
         ...
         * \param window Handle of the application window
         */
        [[deprecated("For best performance use the PredictingDX10Weaver interface")]]
         ...
         * \param width of the side-by-side image to be weaved together
         * \param height of the side-by-side image to be weaved together
         * \bufferFormat Format of the framebuffer view
         * \param window Handle of the application window
         */
    ...
    class [[deprecated("This class is deprecated, please use IDX10Weaver instead.")]] DIMENCOSR_API PredictingDX10Weaver : public DX10WeaverBase {
    public:
        /*!
         * \brief Constructs a class to be used for weaving an input image of a certain size
         * \param context to connect to
         ...
         * \param width of the side-by-side image to be weaved together
         * \param height of the side-by-side image to be weaved together
         * \param bufferFormat Format of the framebuffer view
         * \param window Handle of the application window
         */
